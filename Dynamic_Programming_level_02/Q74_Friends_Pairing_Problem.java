...
public class Q74_Friends_Pairing_Problem {
    ...
    public static long  get_total_pairs(int n) {
        ...
        dp[1] = 1 ;  // this means when dp is of 1 length then it can be divided into only 1 way. thats same
        dp[2] = 2 ;   /// this means when dp is of 2 len then it can be divided into 2 parts.ex ab :  ab or a-b
        int mod = 1000000007 ;
