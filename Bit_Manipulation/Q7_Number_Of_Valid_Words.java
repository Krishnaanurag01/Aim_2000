...
public class Q7_Number_Of_Valid_Words {
    ...
    public static ArrayList<Integer> findNumOfValidWords(String[] words, String[] puzzles) {
        ...
        // now creating mask for each word and then allocating them with corresponing
        // map field
        for (String word : words) {
            ...
            // now again acessing each char of current string and then adding current string
            // mask correspond to each char in map. this denotes that this word contains the
            // current char.
        ...
        for (String puzzle : puzzles) {
            ...
            // now getting all mask(string words) from map which contains the first char of
            // current puzzle
            ...
            for (Integer mask : masks) {
                ...
                // it will give same mask when all the char of mask(word) is present in
                // puzzle(means if same position has 1 bit)
