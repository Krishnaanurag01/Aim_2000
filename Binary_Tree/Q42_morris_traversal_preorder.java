...
import java.util.*;
public class Q42_morris_traversal_preorder {
    ...
    static class TreeNode {
        ...
        public static ArrayList<Integer> morris_traversal_preorder(TreeNode root) {
            ...
            while (curr != null) { // traverse untill it becomes null
                if(curr.left == null){ // if left null then print and move to right becuase we already have made thread to root
                    ...
                    if(prev.right == null){ // when null then connect it with the root.
                        ...
                        list.add(curr.data); // add the data.  /// ************* pre order will insert data here **************
        ...
        public static void main(String[] args) {
           ...
           Q42_morris_traversal_preorder tree = new Q42_morris_traversal_preorder() ;
           ...
           morris_traversal_preorder(tree.root);
        }
}
